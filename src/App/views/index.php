...
<section class="container mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
    ...
    <table class="w-full text-cleft min-w-full text-sm text-gray-500 dark:text-gray-400 mt-6">
        ...
        <tr>
            ...
            <!-- Amount -->
            <td class="p-4 text-sm text-gray-600">0.00</td>
            <!-- Receipt List -->
            ...
            <!-- Date -->
            <td class="p-4 text-sm text-gray-600">07/20/2023</td>
            <!-- Actions -->
        ...
        <tr>
            ...
            <!-- Date -->
            <td class="p-4 text-sm text-gray-600">08/02/2023</td>
            <!-- Actions -->
            <td class="p-4 text-sm text-gray-600 flex justify-center space-x-2">
                <a href="#" class="p-2 bg-amber-50 text-xs text-amber-900 hover:bg-amber-500 hover:text-white transition rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
        ...
        <tr>
            ...
            <!-- Date -->
            <td class="p-4 text-sm text-gray-600">08/12/2023</td>
            <!-- Actions -->
            <td class="p-4 text-sm text-gray-600 flex justify-center space-x-2">
                <a href="#" class="p-2 bg-amber-50 text-xs text-amber-900 hover:bg-amber-500 hover:text-white transition rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
        ...
        <tr>
            ...
            <!-- Date -->
            <td class="p-4 text-sm text-gray-600">08/14/2023</td>
            <!-- Actions -->
            <td class="p-4 text-sm text-gray-600 flex justify-center space-x-2">
                <a href="#" class="p-2 bg-amber-50 text-xs text-amber-900 hover:bg-amber-500 hover:text-white transition rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
